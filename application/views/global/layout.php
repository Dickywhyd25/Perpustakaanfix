...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <link rel="icon" href="<?php echo base_url(); ?>assets2/img/icon2.png">    
    <title>Perpustakaan Ushuludin UIN Sunan Gunung Djati Bandung</title>
...
<body>
            ...
            <nav class="light-blue darken-4">
                <div class="container">
                        ...
                        <div class="nav-wrapper">
                            <a href="<?php echo base_url();?>Buku" class="brand-logo"><img src="<?php echo base_url(); ?>assets2/img/icon2.png" width="45px" alt=""></a>
                            <ul class="right hide-on-med-and-down">
                                <li><a href="<?php echo base_url();?>Buku/list_buku">Daftar Buku</a></li>
                                <li><a href="<?php echo base_url();?>Buku/profile">Tentang Perpustakaan Ushuludin</a></li>
                                <li><a href="<?php echo base_url();?>Buku/jadwal">Jadwal Layanan</a></li>
    ...
    <ul class="sidenav" id="mobile-nav">
        <li><a href="<?php echo base_url();?>Buku/list_buku">Daftar Buku</a></li>
        <li><a href="<?php echo base_url();?>Buku/profile">Tentang Perpustakaan Ushuludin</a></li>
        <li><a href="<?php echo base_url();?>Buku/jadwal"></a>Jadwal Layanan</li>
        <li><a href="<?php echo base_url();?>Buku/panduan">Kontak</a></li>
    </ul>
    <!-- SideNav-end -->
    <!-- Slider -->
    ...
    <div class="section no-pad-bot">
      <div class="container">
        ...
        <div class="row center">
          <img class=" responsive-img z-depth-5" width="200px" src="<?php echo base_url(); ?>assets2/img/icon.png" alt="" srcset="">
        </div>
        <h3 class="header center white-text text-lighten-2 z-depth-5">Perpustakaan Ushuludin UIN Sunan Gunung Djati Bandung</h3>
       

      </div>
    </div>
    <div class="parallax"><img src="<?php echo base_url(); ?>assets2/img/bg.jpg" alt="Unsplashed background img 1"></div>
  </div>
  <!-- Slider end -->
    ...
    <div class="content-wrapper">
        ...
        <footer class="light-blue darken-4">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <a>Fakultas Ushuludin UIN Sunan Gunung Djati Bandung</a>
                </div>
                </div>
            </div>
        </div>
