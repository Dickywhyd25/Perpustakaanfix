...
<div class="box box-solid box-warning">
  <div class="box-header with-border">
   ...
   <div class="box-body">
   <div class="btn-group"><a href="<?php echo base_url(); ?>petugas/buku/tambah_buku"  class="btn btn-success" role="button" data-toggle="tooltip" title="Tambah Data Buku"><i class="fa fa-plus"></i>  Tambah Data Buku</a></div>
...
<?php
  ...
  <div class="box-footer">
    Menampilkan daftar buku, untuk melihat detail buku klik tombol + , mengedit dan menghapus buku klik tombol pada kolom pilihan.
  </div><!-- box-footer -->
</div><!-- /.box -->
