...
<div class="box box-solid box-primary">
  ...
  <div class="btn-group">
   ...
   <tr>
     <td><h5><b> Jurusan</b></h5></td> <td><h5><b> : </b></h5></td>
     <td><h5><b><?php foreach ($data_pinjam->result_array() as $key => $value1) {
      $id_anggota=$value1['id_anggota'];
     } 
   foreach ($data_anggota->result_array() as $key => $value) {
            ...
            <tr>
                ...
                <?php echo 
                    ...
                    if($op['status']==0  )
                    {
                     ...
                     '&nbsp<a href="'.base_url().'admin/Pinjam/edit_pinjam/?id_pinjam='.$op['id_pinjam'].'" class="btn btn-warning" role="button" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>';
                     if($op['total_buku']>0){
                     echo 
                     '&nbsp<a href="'.base_url().'admin/Kembali/?id_pinjam='.$op['id_pinjam'].'" class="btn btn-warning" role="button" data-toggle="tooltip" title="Kembalikan"><i class="fa fa-share"></i></a>';
                    }
                  }
                    if($op['status']==1 ){
                    echo 
                    '&nbsp<span data-toggle="modal" data-target="#confirm-delete" data-href="'.base_url().'admin/Pinjam/hapus_kembali/?id_pinjam='.$op['id_pinjam'].'">
