...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url();?>admin/Home" class="logo">
      ...
      <span class="logo-lg"><b>Perpus </b>Ushuludin</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <center>
        <a href="<?php echo base_url();?>admin/Home">
          <img src="<?php echo base_url(); ?>assets2/img/logo1.png" alt="" srcset="" width="47px">
        </a>
      </center>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong><a href="#">SI Perpustakaan Ushuludin</a>.</strong> 
  </footer>
